<%-- 
    Document   : customer_confirm_paypal
    Created on : Nov 28, 2019, 1:28:40 PM
    Author     : LeVaLu
--%>
    ...
    <body>
        <div class="container">
            ...
            <div class="row mt-5 ml-5 mb-5">
                <c:if test="${not empty sessionScope.ORDER_PAYMENT.listBook}" var="list">
                    <div class="col-7 mx-auto">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:forEach items="${sessionScope.ORDER_PAYMENT.listBook}" var="item">
                                            <tr>
                                                <td>
                        ...
                        <div class="row mt-3">
                            <div class="col-3 ml-auto text-right">
                                <h4 class="text-primary font-weight-bold font-italic">- ${sessionScope.ORDER_PAYMENT.discountValue}</h4>
                            </div>
                        </div>
                        <div class="tbl-divider"></div>
                        <div class="row mt-3">
                            ...
                            <div class="col-8 ml-auto text-right">
                                <h4 class="text-primary font-weight-bold">${sessionScope.ORDER_PAYMENT.total}</h4>
                            </div>
                        </div>
