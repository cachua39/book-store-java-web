...
public class LoginController extends HttpServlet {
    private static final String ERROR = "erorr.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String roleName = accountBean.checkLogin();
            
            if(roleName.equals("failed")) {
                AccountError accountError = new AccountError();
                accountError.setAccountError("Invalid userId or password!");
                request.setAttribute("INVALID", accountError);
                url = INVALID;
            }else{
                HttpSession session = request.getSession();
                AccountDTO accountDTO = new AccountDTO(userId, roleName);
