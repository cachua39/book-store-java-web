...
public class AuthFilter implements Filter {
    ...
    public AuthFilter() {
        ...
        guestResources.add("page_not_found.jsp");

        // Controller resources for guess
        guestResources.add("login");
        guestResources.add("logout");
        guestResources.add("loadAllBookByUser");
        guestResources.add("loadAllCategory");
        guestResources.add("searchByUser");
        ...
        customerResources.add("page_not_found.jsp");
        customerResources.add("role_not_support.jsp");
        ...
        customerResources.add("customer_confirm_paypal.jsp");
        // Controller resources for customer
        customerResources.add("logout");
        customerResources.add("loadAllBookByUser");
        customerResources.add("loadAllCategory");
        customerResources.add("addToCart");
        customerResources.add("updateCart");
        customerResources.add("deleteFromCart");
        customerResources.add("update_info.jsp");
        customerResources.add("loadInfoBeforeCheckOut");
        customerResources.add("checkCoupon");
        customerResources.add("customter_checkout.jsp");
        customerResources.add("checkout");
        customerResources.add("customer_confirm.jsp");
        customerResources.add("searchByUser");
        ...
        adminResources.add("role_not_support.jsp");
        adminResources.add("page_not_found.jsp");
        adminResources.add("admin_create_book.jsp");
        adminResources.add("admin_create_account.jsp");
        adminResources.add("admin_insert_account.jsp");
        // Controller resources for admin
        adminResources.add("logout");
        adminResources.add("loadAllBookByAdmin");
        adminResources.add("loadAllCategory");
        adminResources.add("insertBookByAdmin");
        adminResources.add("InsertBookByAdminController");
        adminResources.add("editBookByAdmin");
        adminResources.add("UpdateBookByAdminController");
        adminResources.add("deleteBookByAdmin");
        adminResources.add("update_info.jsp");
        adminResources.add("loadAllRole");
        adminResources.add("insertAccount");
    }
                    ...
                    if (!guestResources.contains(resource)
                        ...
                        if (accountDTO.getRole().equals("Admin")) {
                            if (adminResources.contains(resource)) {
                                ...
                                if (resource.equals("login.jsp") || resource.equals("login") || resource.equals("")) {
                        ...
                        else if (accountDTO.getRole().equals("Customer")) {
