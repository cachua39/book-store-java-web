        ...
        try {
            ...
            if (resource.length() > 0) {
                if (resource.lastIndexOf(".jsp") > 0) {
                    url = resource;
                } else if (resource.lastIndexOf(".js") > 0) {
                    url = resource;
                } else if (resource.lastIndexOf(".css") > 0) {
                    url = resource;
                } else if (resource.lastIndexOf(".jpg") > 0) {
                    url = resource;
                } else if (resource.lastIndexOf(".png") > 0) {
                    url = resource;
                } else if (resource.lastIndexOf(".jpeg") > 0) {
                    url = resource;
                } else if(resource.lastIndexOf(".JPG") > 0){
                    url = resource;
                }
            ...
            log("Error at FilterDispatcher: " + t.getMessage());
        }
    }
